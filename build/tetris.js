...
var $author$project$Tablero$Empty = {$: 'Empty'};
...
var $perty$matrix$Matrix$repeat = F3(
	function (sizeX, sizeY, value) {
		return A2(
			$elm$core$Array$repeat,
			sizeX,
			A2($elm$core$Array$repeat, sizeY, value));
	});
var $author$project$Tablero$initTablero = A3($perty$matrix$Matrix$repeat, 20, 10, $author$project$Tablero$Empty);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = _Utils_Tuple2(
	{lastEvent: $elm$core$Maybe$Nothing, points: 0, state: $author$project$Main$NotStarted, tablero: $author$project$Tablero$initTablero},
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2($elm$json$Json$Decode$map, $author$project$Main$HandleKeyboardEvent, $Gizra$elm_keyboard_event$Keyboard$Event$decodeKeyboardEvent))
			]));
};
var $author$project$Main$Countdown = function (a) {
	return {$: 'Countdown', a: a};
};
					...
					case 3:
						return _Utils_Tuple2(
							_Utils_update(
								...
								{
									points: 0,
									state: $author$project$Main$Starting(n),
									tablero: $author$project$Tablero$initTablero
								}),
							A2(
								$author$project$Main$delay,
								1000,
								$author$project$Main$Countdown(n - 1)));
					case 0:
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{state: $author$project$Main$Playing}),
							$elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(
							_Utils_update(
			...
			case 'HandleKeyboardEvent':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							lastEvent: $elm$core$Maybe$Just(event)
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$viewEvent = function (maybeEvent) {
	if (maybeEvent.$ === 'Just') {
			...
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								'altKey: ' + $elm$core$Debug$toString(event.altKey),
								'ctrlKey: ' + $elm$core$Debug$toString(event.ctrlKey),
								'key: ' + $elm$core$Debug$toString(event.key),
								'keyCode: ' + $elm$core$Debug$toString(event.keyCode),
								'metaKey: ' + $elm$core$Debug$toString(event.metaKey),
								'repeat: ' + $elm$core$Debug$toString(event.repeat),
								'shiftKey: ' + $elm$core$Debug$toString(event.shiftKey)
							])))
				]));
	} else {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('No event yet')
				]));
	}
};
...
var $perty$matrix$Matrix$size = function (matrix) {
	var sizeY = function () {
...
var $author$project$Tablero$viewCountdown = function (n) {
	if (!n) {
...
var $author$project$Tablero$tileSvg = function (t) {
	switch (t.$) {
		case 'I':
			return 't-i';
		case 'O':
...
var $author$project$Tablero$viewTile = function (tile) {
	if (tile.$ === 'Filled') {
		var tetrad = tile.a;
		return A2(
			$elm$html$Html$li,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('t-tile', true),
							_Utils_Tuple2(
							$author$project$Tablero$tileSvg(tetrad),
							true)
						]))
				]),
			_List_Nil);
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('t-tile-empty')
				]),
			_List_Nil);
	}
};
var $author$project$Tablero$viewRow = function (row) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('t-row')
			]),
		$elm$core$Array$toList(
			A2($elm$core$Array$map, $author$project$Tablero$viewTile, row)));
};
var $author$project$Tablero$viewTablero = F2(
	function (tablero, countdown) {
		var _v0 = $perty$matrix$Matrix$size(tablero);
		var x = _v0.a;
		var y = _v0.b;
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('t-tablero')
				]),
			$elm$core$List$concat(
				_List_fromArray(
					[
						_List_fromArray(
						[
							$author$project$Tablero$viewCountdown(countdown)
						]),
						A2(
						$elm$core$List$map,
						function (row) {
							return $author$project$Tablero$viewRow(
								A2($perty$matrix$Matrix$getXs, tablero, row));
						},
...
var $author$project$Main$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('buscaminas')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$Countdown(3))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Start')
					])),
				A2($author$project$Tablero$viewTablero, model.tablero, countdown),
				$author$project$Main$viewEvent(model.lastEvent)
			]));
};
